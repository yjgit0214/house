...
<%
  ...
  if (o==null){
      out.print("<script>alert('您还没有登入或超时');location.href='login.jsp';</script>");
  }
%>
...
<LABEL class=ui-green><a href="index.jsp"><INPUT onclick="location.href='index2.jsp'" value="退       出" type=button name=search> </a></LABEL>
</DIV></DIV>
<DIV class="main wrap">
<DIV id=houseArea>
...
<c:forEach items="${pageInfo.list}" var="h">
  <TR>
    ...
    <TD class=house-type><LABEL class=ui-green><INPUT onclick="location.href='getHouse?id=${h.id}'" value="修    改" type=button name=search></LABEL></TD>
    <TD class=house-price><LABEL class=ui-green><INPUT onclick="delHouse(this,${h.id})" value="删    除" type=button name=search></LABEL>
    </TD></TR>
</c:forEach>
  </TBODY></TABLE></DIV>
<DIV class=pager>
